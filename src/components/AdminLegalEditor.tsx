    ...
    <section className="admin-legal">
      ...
      {draft ? <div className="admin-legal__workspace">
        <div className="admin-legal__editor">
          ...
          <label><span>Opening summary</span><textarea data-lenis-prevent data-lenis-prevent-wheel data-lenis-prevent-touch value={draft.introduction} maxLength={1200} rows={5} placeholder="A short, reader-friendly introduction…" onChange={(event) => setDraft({ ...draft, introduction: event.target.value })} /></label>
